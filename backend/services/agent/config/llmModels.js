...
const googleKey = process.env.GOOGLE_API_KEY && !process.env.GOOGLE_API_KEY.includes("add your") && process.env.GOOGLE_API_KEY.startsWith("AIzaSy") ? process.env.GOOGLE_API_KEY : null;
