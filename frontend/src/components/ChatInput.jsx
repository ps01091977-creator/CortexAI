...
function ChatInput() {
  ...
  return (
    <div className='w-full overflow-hidden px-3 md:px-5 py-4 border-t border-white/[0.05] bg-[#0d0f14]'>
      <div className='flex flex-col gap-2 bg-white/[0.02] border border-white/[0.06] focus-within:border-indigo-500/35 focus-within:shadow-[0_0_15px_rgba(99,102,241,0.08)] transition-all duration-300 rounded-2xl px-4 pt-3.5 pb-3'>
